...
Mobile.tap(findTestObject('Object Repository/Approve Workspace/tap_edit'), 10)

Mobile.tap(findTestObject('Object Repository/Approve Workspace/edit_name'), 10)

Mobile.setText(findTestObject('Object Repository/Approve Workspace/edit_name'), edit_name, 10)

driver.pressKey(new KeyEvent(AndroidKey.BACK))

Mobile.tap(findTestObject('Object Repository/Approve Workspace/edit_desc'), 10)

Mobile.setText(findTestObject('Object Repository/Approve Workspace/edit_desc'), edit_desc, 10)
...
int startX1 = device_Width / 2
 
'Here startX and endX values are equal for vertical Swiping for that assigning startX value to endX'
int endX1 = startX

'Storing the startY value'
int startY1 = device_Height * 0.30

'Storing the endY value'
int endY1 = device_Height * 0.70
