...
//Mobile.tap(findTestObject('Object Repository/LOGIN/Klik_Started'), 30)

Mobile.tap(findTestObject('Object Repository/LOGIN/android.widget.EditText - Enter Username'), 0)

Mobile.setText(findTestObject('Object Repository/LOGIN/android.widget.EditText - Enter Username (1)'), username, 0)
