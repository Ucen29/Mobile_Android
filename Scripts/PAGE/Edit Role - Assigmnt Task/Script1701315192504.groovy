...
// Menghitung koordinat titik tap back
...
Mobile.tap(findTestObject('Object Repository/My Task/Tap_yes'), 30)

Mobile.waitForElementPresent(findTestObject('Object Repository/My Task/View_text'), 30)
